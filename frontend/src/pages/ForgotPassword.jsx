...
import { Mail, ArrowLeft, Loader2, Activity } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-dark-900 px-4">
            ...
            <div className="relative w-full max-w-md animate-fade-in">
                ...
                <div className="glass-card rounded-2xl p-8">
                    ...
                    <p className="text-sm text-slate-400 text-center mb-6">Enter your email to receive a reset link</p>
                    ...
                    {message && (
                        <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm px-4 py-3 rounded-lg mb-5">
                            {message}
                        </div>
                    )}
